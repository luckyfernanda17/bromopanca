...
export default function StaticViews({
  viewType,
  onNavigate,
}: StaticViewsProps) {
  ...
  if (viewType === 'faq') {
    return (
      <div
        ...
        className="animate-fade-in text-gray-200"
      >
        <SEOHead
        ...
        <section className="bg-forest-900 border-b border-gold-400/10 pt-32 pb-16 text-center">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <p className="mt-4 text-xs sm:text-sm text-gray-400 max-w-2xl mx-auto font-light">
              Pertanyaan umum mengenai tata cara pemesanan, kebijakan uang
              muka (DP), penjemputan, hingga kiat berlibur nyaman di Jawa
              Timur.
            </p>
          </div>
        </section>
          ...
          <div className="max-w-4xl mx-auto px-4">
            <div className="space-y-4">
              {fags.map((item, idx) => (
                <div
                  key={idx}
                  className="border border-gold-400/15 bg-forest-900 rounded-2xl overflow-hidden shadow-lg"
                >
                  <button
            ...
            <div className="mt-12 bg-forest-900 border border-gold-400/10 p-6 rounded-2xl text-center">
              <h4 className="font-serif font-bold text-gold-100 text-lg">
                Ada Pertanyaan Tambahan?
              </h4>

              <p className="text-xs text-gray-400 mt-2 font-light">
                Hubungi WhatsApp Chat admin 24 jam kami untuk respon langsung
                yang ramah.
              </p>
      ...
      >
        ...
        <section className="bg-forest-900 border-b border-gold-400/10 pt-32 pb-16 text-center">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <p className="mt-4 text-xs sm:text-sm text-gray-400 max-w-2xl mx-auto font-light">
              Konsultasikan rencana liburan, request custom itinerary, sampaikan
              saran, atau reservasi jeep Land Cruiser Anda dengan mudah.
            </p>
          </div>
        </section>
    ...
    >
      ...
      <section className="bg-forest-900 border-b border-gold-400/10 pt-32 pb-16 text-center">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <p className="mt-4 text-xs sm:text-sm text-gray-400 max-w-2xl mx-auto font-light">
            Mendedikasikan diri menghadirkan pariwisata petualangan alam East
            Java yang profesional, aman, beretika sosial, dan bercita rasa
            luxury.
          </p>
        </div>
      </section>
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 space-y-16">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <h2 className="font-serif font-bold text-2xl text-gold-150 uppercase">
                Asal Mula Berdirinya Bromo Panca
              </h2>

              <p className="text-xs sm:text-sm text-gray-400 mt-4 leading-relaxed font-light">
                Bromo Panca didirikan di lereng Wonokitri oleh sekelompok
                pemuda lokal suku Tengger bersama praktisi pariwisata lulusan
                pariwisata Universitas Brawijaya. Dimulai dari satu unit jip
                4x4 Land Cruiser klasik, saat ini kami mengelola armada yang
                luas, menjalin kolaborasi erat dengan homestay, porter Ijen,
                serta ranger lokal Tumpak Sewu.
              </p>

              <p className="text-xs sm:text-sm text-gray-400 mt-4 leading-relaxed font-light">
                Kami percaya, kenyamanan perjalanan berkualitas tinggi didapat
                dari standard ketat pemeliharaan kendaraan, akurasi asuransi,
                kebersihan akomodasi kuliner pariwisata harian, dan ketulusan
                senyum pelayanan lokal.
              </p>
            </div>
          ...
          <div className="border-t border-gold-400/10 pt-16">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-8">
              ...
              <div className="bg-forest-900 border border-gold-400/10 p-6 rounded-2xl">
                ...
                <h4 className="font-serif font-bold text-gold-200 text-base">
                  Ethical Social
                </h4>

                <p className="text-xs text-gray-400 mt-2 font-light leading-relaxed">
                  Sebagian keuntungan disalurkan kembali dalam bentuk edukasi
                  bahasa Inggris bagi anak-anak porter Ijen dan pemeliharaan
                  jalur ekologi TNBTS.
                </p>
              </div>
              ...
              <div className="bg-forest-900 border border-gold-400/10 p-6 rounded-2xl">
                ...
                <p className="text-xs text-gray-400 mt-2 font-light leading-relaxed">
                  Dari penjemputan bandara on-time dengan wewangian aromaterapi
                  di mobil, kargo ransel tertata bersih di jeep, hingga sarapan
                  higienis bergizi tinggi.
                </p>
              </div>
              ...
              <div className="bg-forest-900 border border-gold-400/10 p-6 rounded-2xl">
                ...
                <h4 className="font-serif font-bold text-gold-200 text-base">
                  Pure Guest Satisfaction
                </h4>

                <p className="text-xs text-gray-400 mt-2 font-light leading-relaxed">
                  Mendengarkan masukan tamu secara personal, sedia melayani
                  penyesuaian hotel s.d H-3, &amp; sigap memberikan tips baju
                  hangat bebas repot.
                </p>
              </div>
